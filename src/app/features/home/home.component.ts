...
export class HomeComponent implements AfterViewInit {
  ...
  brands = [
    { id: 'nocco',     label: 'NOCCO',     logo: 'images/logos/logo-nocco.png',  desc: 'BCAA Energy Drinks'  },
    { id: 'barebells', label: 'Barebells', logo: 'images/logos/logo-barebells.svg',              desc: 'Protein Bars'         },
    { id: 'iogenix',   label: 'iOGenix',   logo: 'images/logos/logo-iogenix.png',              desc: 'Whey Protein'         },
  ];
